...
class Command:
    ...
    def handle_command(self, user, command, params=None):
        if command in self.commands:
            ...
            response = 'Pruu errou o comando: {command}. {help}'.format(
                command=command,
                help=self.help()
            )
    ...
    def add_repo(self, params):
        if 'help' in params:
            return (
                'Para adicionar repositorio chame da seguinte forma:'
        ...
        try:
            ...
            return (
                'Comando com parametros inválidos, digite '
                '`@octopombo add-repo help` para verificar como executar.'
            )

    def remove_repo(self, params):
        if 'help' in params:
            return (
                'Para remover um repositório, chame da seguinte forma:'
        ...
        try:
            ...
            return (
                'Comando com parametros inválidos, digite `@octopombo '
                'remove-repo help` para verificar como executar.'
            )
    ...
    def show_prs(self, params):
        ...
        if 'help' in params:
            return (
                'Para listar os prs em aberto chame da seguinte forma:'
                '```@Octopombo show-prs```'
            )
        ...
        try:
            ...
            return (
                'Comando com parametros invalidos, digite `@octopombo '
                'show-prs help` para verificar como executar.'
            )
